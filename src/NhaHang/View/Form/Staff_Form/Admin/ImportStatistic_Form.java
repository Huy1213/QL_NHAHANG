...
public class ImportStatistic_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdCTNK = new NhaHang.View.Swing.Button();
        cmdExcel = new NhaHang.View.Swing.Button();
    ...
    private NhaHang.View.Swing.Button cmdCTNK;
    private NhaHang.View.Swing.Button cmdExcel;
