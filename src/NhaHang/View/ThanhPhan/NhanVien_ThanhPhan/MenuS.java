...
public class MenuS extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/table.png")), "Quản lý đặt món", "Đặt trước và gọi món"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/table.png")), "Quản lý đặt bàn", "Bàn ăn"));
