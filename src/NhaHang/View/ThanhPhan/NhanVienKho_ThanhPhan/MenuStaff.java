package NhaHang.View.ThanhPhan.NhanVienKho_ThanhPhan;
...
public class MenuStaff extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        ...
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/nglieu.png")), "Quản lý Kho"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/nglieu.png")), "Quản lý Nhập kho"));
