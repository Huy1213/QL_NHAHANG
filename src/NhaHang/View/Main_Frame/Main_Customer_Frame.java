...
import NhaHang.View.ThanhPhan.KhachHang_ThanhPhan.Menu;
import NhaHang.View.Form.KhachHang_Form.AccountC_Form;
import NhaHang.View.Form.KhachHang_Form.Bill_Form;
import NhaHang.View.Form.KhachHang_Form.FoodMenu_Form;
import NhaHang.View.Form.MainForm;
import NhaHang.View.Form.KhachHang_Form.TableMenu_Form;
                ...
                switch (menuIndex) {
                    ...
                    case 1 -> {
                        switch (subMenuIndex) {
                            ...
                            case 7 -> main.showForm(new FoodMenu_Form("De",user));
                            case 8 -> main.showForm(new FoodMenu_Form("DoUong",user));
                            case 9 -> main.showForm(new FoodMenu_Form("Ca",user));
                            default -> {
                            }
                        }
                    }
